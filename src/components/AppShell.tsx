...
export function AppShell({ children, variant = "default" }: AppShellProps) {
  ...
  return (
    <div className={cn("site-shell min-h-screen text-[#f8edd8]", isTransparent && "site-shell--transparent")}>
      ...
      {/* Footer */}
      <footer className="border-t border-[#f5c85b]/20 bg-[#1c0a0c] px-5 pb-24 pt-6 text-[#f8edd8] lg:px-10 lg:pb-6">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <p className="font-bengali text-sm font-bold text-[#f5c85b]">
              {bengali ? "এই পুজো আপনার।" : "This Puja is Yours."}
            </p>
          </div>
          <div className="flex items-center gap-2 sm:gap-4 text-xs text-[#f8edd8]/75">
            <span className="hidden sm:inline">{bengali ? "কলকাতার জন্য, ভালোবাসায় তৈরি" : "Made for Kolkata, with love"}</span>
            <a href="https://github.com/Sohan-ghosh835" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 rounded-full border border-[#f5c85b]/30 bg-[#f5c85b]/10 px-3 py-1.5 font-semibold text-[#f5c85b] transition hover:bg-[#f5c85b]/20">
